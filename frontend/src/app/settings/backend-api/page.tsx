    ...
    endpoints: [
      {
        ...
        requiresAuth: true,
        bodyExample: JSON.stringify(
          { name: "Клиент", email: "client@mail.ru", phone: "+375 29 292929" },
          null,
          2
        ),
      },
    ...
    endpoints: [
      {
        ...
        requiresAuth: true,
        bodyExample: JSON.stringify(
          { title: "Задача", leadId: "uuid", assignedToId: "uuid" },
          null,
          2
        ),
      },
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        requiresAuth: true,
        bodyExample: JSON.stringify(
          { name: "Новое имя", email: "new@mail.ru" },
          null,
          2
        ),
      },
          ...
          <div className="space-y-1">
            ...
            {endpoint.path.includes(":id") && (
              <p className="text-[11px] text-muted-foreground">
                Замените <code className="bg-muted px-1 rounded">:id</code> на
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {httpStatus && (
                    <span
                      className={`text-xs font-mono px-1.5 py-0.5 rounded font-medium ${STATUS_STYLE(
                        httpStatus
                      )}`}
                    >
                      {httpStatus}
              ...
              <ScrollArea className="h-48 border rounded-md">
                <pre className="text-xs font-mono p-3 whitespace-pre-wrap break-all leading-relaxed">
                  {response}
                </pre>
              </ScrollArea>
            </div>
...
export default function BackendApiPage() {
  return (
    <div className="mx-auto space-y-6">
      <TitleSEO
        title="Эндпоинты"
        description="Документация и интерактивное тестирование эндпоинтов"
        canonical="/settings/backend-api"
      />
          ...
          <Card className="max-w-xl">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <a
                  href={`${env.NEXT_PUBLIC_API_URL}/api`}
                  target="_blank"
                ...
                <a
                  href={`${env.NEXT_PUBLIC_API_URL}/api/json`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground font-mono">
                        {env.NEXT_PUBLIC_API_URL}/api/json
                      </p>
                    </div>
                  </div>
